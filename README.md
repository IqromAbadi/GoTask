...
5. [Setup & Instalasi](#setup)
 ...
 - [Opsi Supabase (Cloud)](#supabase)
6. [Menjalankan & Menghentikan Server](#run-stop)
7. [Deployment ke Koyeb (Gratis)](#deployment)
8. [API Endpoints](#api-endpoints)
9. [Contoh Request/Response](#api-examples)
10. [Task Workflow](#task-workflow)
11. [Business Rules](#business-rules)
12. [ERD (Diagram Database)](#erd)
13. [Arsitektur](#architecture)
...
### Opsi: Pakai Supabase (PostgreSQL Cloud — Tanpa Install Lokal)
...
### 1 Install Tools & Database (sekali saja)
...
### 2 Menjalankan Server (setiap kali coding)
...
> **Server tidak otomatis baca file `.env`** — environment variable harus di-export dulu. Lihat langkah 3 di bawah.

### 3 Cara Paling Simpel (pakai .env otomatis)
...
echo " Menjalankan GoTask di http://localhost:${APP_PORT:-8080}"
